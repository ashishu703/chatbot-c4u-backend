...
router.post("/send-image", validateUser, chatController.sendImage.bind(chatController));
router.post("/send-video", validateUser, chatController.sendVideo.bind(chatController));
router.post("/send-doc", validateUser, chatController.sendDoc.bind(chatController));
router.post("/send-audio", validateUser, chatController.sendAudio.bind(chatController));

// -------- AGENT CHAT ROUTES --------
router.post("/send-agent-message", validateAgent, chatController.send.bind(chatController));
router.post("/send-agent-image", validateAgent, chatController.sendImage.bind(chatController));
router.post("/send-agent-video", validateAgent, chatController.sendVideo.bind(chatController));
router.post("/send-agent-doc", validateAgent, chatController.sendDoc.bind(chatController));
router.post("/send-agent-audio", validateAgent, chatController.sendAudio.bind(chatController));
